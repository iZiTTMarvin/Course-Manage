package com.example.springboot.common.generator;
...
public class GeneratorMySQL {
     ...
     * 数据库连接url
     */
    public static final String URL = "jdbc:mysql://localhost/db_course";
    /**
     * 数据库 用户名
     */
...
//    public static final String SAVE_PATH = System.getProperty("user.dir") + "/src/main/java";
     ...
     * 要生成的表
     */
    public static final String[] TABLES = {"course_team"};
    public static final String[] TablePrefix = {"course_"};
    public static final String[] FieldPrefix = {"team_"};
