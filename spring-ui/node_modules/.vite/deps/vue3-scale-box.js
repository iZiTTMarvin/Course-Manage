...
// node_modules/vue3-scale-box/dist/vue3-scale-box.umd.min.js
var require_vue3_scale_box_umd_min = __commonJS({
  "node_modules/vue3-scale-box/dist/vue3-scale-box.umd.min.js"(exports, module) {
    (function(e, t) {
      "object" === typeof exports && "object" === typeof module ? module.exports = t(require_vue()) : "function" === typeof define && define.amd ? define([], t) : "object" === typeof exports ? exports["vue3ScaleBox"] = t(require_vue()) : e["vue3ScaleBox"] = t(e["Vue"]);
    })("undefined" !== typeof self ? self : exports, function(e) {
      return function() {
        "use strict";
        var t = { 203: function(t2) {
          t2.exports = e;
        } }, n = {};
        function r(e2) {
          var o2 = n[e2];
          ...
          function a(e3, t3) {
            ...
            return function() {
              ...
              n3 && clearTimeout(n3), n3 = setTimeout(function() {
                n3 = null, e3.apply(r2, o2);
              }, t3);
            };
          }
          var i = { width: { type: Number, default: 1920 }, height: { type: Number, default: 1080 }, bgc: { type: String, default: "transparent" }, delay: { type: Number, default: 100 }, isFlat: { type: Boolean, default: false } }, l = { __name: "index", props: i, emits: ["scaleChange"], setup(e3, { emit: t3 }) {
            const r2 = e3;
            (0, n2.onMounted)(() => {
              p(), window.addEventListener("resize", a(p, r2.delay));
            });
            const o2 = (0, n2.ref)(null), i2 = (0, n2.reactive)({ position: "fixed", transform: "scale(var(--scale)) translate(-50%, -50%)", transformOrigin: "0 0", left: "50%", top: "50%", zIndex: 999 });
            r2.isFlat ? i2["transform"] = "scaleX(var(--scaleX)) scaleY(var(--scaleY)) translate(-50%, -50%)" : i2["transform"] = "scale(var(--scale)) translate(-50%, -50%)";
            const l2 = (0, n2.ref)(0);
            function u2() {
              const e4 = window.innerHeight / r2.height, t4 = window.innerWidth / r2.width;
              return t4 < e4 ? t4 : e4;
            }
            const c2 = (0, n2.ref)(0), s2 = (0, n2.ref)(0);
            function f() {
              const e4 = window.innerWidth / r2.width;
              return e4;
            }
            function d() {
              const e4 = window.innerHeight / r2.height;
              return e4;
            }
            function p() {
              o2.value && (r2.isFlat ? (c2.value = f(), s2.value = d(), o2.value.style.setProperty("--scaleX", c2.value), o2.value.style.setProperty("--scaleY", s2.value)) : (l2.value = u2(), o2.value.style.setProperty("--scale", l2.value)));
            }
            return (0, n2.watchEffect)(() => {
              let e4 = [l2.value];
              e4 = r2.isFlat ? [c2.value, s2.value] : l2.value, t3("scaleChange", e4);
            }), (e4, t4) => ((0, n2.openBlock)(), (0, n2.createElementBlock)("div", { class: "roc-scale-box", ref_key: "rocScaleBox", ref: o2, style: (0, n2.normalizeStyle)({ ...i2, width: r2.width + "px", height: r2.height + "px", backgroundColor: r2.bgc }) }, [(0, n2.renderSlot)(e4.$slots, "default")], 4));
          } };
          const u = l;
          var c = u, s = c;
        }(), o = o["default"], o;
...
export default require_vue3_scale_box_umd_min();
...
vue/dist/vue.cjs.js:
  ...
  **)
*/
//# sourceMappingURL=vue3-scale-box.js.map
