...
const tableType  = [
  ...
  , {label: '人数', width: '', rules: [{required: 'true', message: '请输入人数', trigger: 'blur'}], showType: '', prop: 'count'}
  , {label: '权限', width: '', rules: [{required: 'true', message: '请输入权限', trigger: 'blur'}], showType: 'tree', prop: 'rmp'}
